...
while True:
    ...
    cv2.putText(frame, "c : " + str(count['c']), (10, 80), cv2.FONT_HERSHEY_PLAIN, 1, (0, 255, 255), 1)
    cv2.putText(frame, "d : " + str(count['d']), (10, 90), cv2.FONT_HERSHEY_PLAIN, 1, (0, 255, 255), 1)
    ...
    cv2.putText(frame, "h : " + str(count['h']), (10, 130), cv2.FONT_HERSHEY_PLAIN, 1, (0, 255, 255), 1)
    cv2.putText(frame, "i : " + str(count['i']), (10, 140), cv2.FONT_HERSHEY_PLAIN, 1, (0, 255, 255), 1)
    cv2.putText(frame, "j : " + str(count['j']), (10, 150), cv2.FONT_HERSHEY_PLAIN, 1, (0, 255, 255), 1)
    ...
    cv2.putText(frame, "0 : " + str(count['0']), (10, 320), cv2.FONT_HERSHEY_PLAIN, 1, (0, 255, 255), 1)
    cv2.putText(frame, "1 : " + str(count['1']), (10, 330), cv2.FONT_HERSHEY_PLAIN, 1, (0, 255, 255), 1)
    cv2.putText(frame, "2 : " + str(count['2']), (10, 340), cv2.FONT_HERSHEY_PLAIN, 1, (0, 255, 255), 1)
    cv2.putText(frame, "3 : " + str(count['3']), (10, 350), cv2.FONT_HERSHEY_PLAIN, 1, (0, 255, 255), 1)
    cv2.putText(frame, "4 : " + str(count['4']), (10, 360), cv2.FONT_HERSHEY_PLAIN, 1, (0, 255, 255), 1)
    cv2.putText(frame, "5 : " + str(count['5']), (10, 370), cv2.FONT_HERSHEY_PLAIN, 1, (0, 255, 255), 1)
    cv2.putText(frame, "6 : " + str(count['6']), (10, 380), cv2.FONT_HERSHEY_PLAIN, 1, (0, 255, 255), 1)
    cv2.putText(frame, "7 : " + str(count['7']), (10, 390), cv2.FONT_HERSHEY_PLAIN, 1, (0, 255, 255), 1)
    cv2.putText(frame, "8 : " + str(count['8']), (10, 400), cv2.FONT_HERSHEY_PLAIN, 1, (0, 255, 255), 1)
    cv2.putText(frame, "9 : " + str(count['9']), (10, 410), cv2.FONT_HERSHEY_PLAIN, 1, (0, 255, 255), 1)
